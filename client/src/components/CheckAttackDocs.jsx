...
export const CheckAttackDocs = () => {
  return (
    <div className="p-6 max-w-4xl mx-auto font-sans">
      ...
      <p className="mb-4">
        When you call <code>checkAttack(auth, input_id, input_id)</code>, you receive a response object like this:
      </p>
      ...
      <ul className="list-disc list-inside mb-6">
        ...
        <li>
          ...
          <ul className="list-disc list-inside ml-5 mt-2">
            ...
            <li><strong>location</strong>: Country, region, timezone.</li>
